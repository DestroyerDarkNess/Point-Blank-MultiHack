...
Class WinEightTheme
    ...
    Protected Overrides Sub PaintHook()
        ...
        G.FillRectangle(New SolidBrush(Color.FromArgb(240, 240, 240)), 10, 20, Width - 20, Height - 30)
        G.DrawLine(P2, 0, 0, Width, 0)
        DrawText(Brushes.White, HorizontalAlignment.Center, 0, 0)
    End Sub
End Class

Class WinEightButton
